...
public final class BeanUtil {
     ...
     * @param bean	Bean对象
     * @param ignoreCollectionProperty 是否忽略集合属性
     * @return			返回Hash值	
     */
