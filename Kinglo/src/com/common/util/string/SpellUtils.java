...
public abstract class SpellUtils {
    ...
    public final static HashMap<String, String> surnameMap = new HashMap<String, String>(
	    415);

    private final static LinkedHashMap<String, Integer> spellMap = new LinkedHashMap<String, Integer>(
	    400);;
	...
	ArrayList<String> surnameFirstSpellList = new ArrayList<String>(
		surnameFirstSpellSet);
	Collections.sort(surnameFirstSpellList);

	return ArrayUtil.toArray(surnameFirstSpellList);
    }

    public static void main(String[] args) {
	char chinese = '中';
	System.out.println("汉字名称:" + chinese);
	System.out
		.println("获取汉字'" + chinese + "'的Ascii:" + getCnAscii(chinese));
	System.out.println("根据汉字'" + chinese + "'的Ascii查询拼音:"
		+ getSpellByAscii(getCnAscii(chinese)));

	String str = "我是邹建华";
	System.out.println("汉字字符串为:" + str);
	System.out.println("获取'" + str + "'的全拼:" + getFullSpell(str));
	System.out.println("获取'" + str + "'的拼音首字母:" + getFirstSpell(str));
	System.out.println("获取'" + str + "'的拼音缩写:" + getAbbreviateSpell(str));
	System.out.println("取得一批姓名的姓的首字母字符串数组----只是列出有此功能 不演示!");
    }
