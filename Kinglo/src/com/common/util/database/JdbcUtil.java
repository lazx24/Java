...
public abstract class JdbcUtil {
	...
	int fromIndex = StringUtil.getFirstPairIndex(lowerCaseSql, "select ",
		" from ");
	if (fromIndex == -1) {
	...
	int groupByIndex = StringUtil.getFirstPairIndex(lowerCaseSql,
		" group ", " by ");
	...
	System.out.println("getSQL：" + getSQL(preparedSQL, objects));
	System.out.println("getCountSQL:" + getCountSQL(preparedSQL));
	System.out.println("getInSQL:" + getInSQL(5));
    }
}
