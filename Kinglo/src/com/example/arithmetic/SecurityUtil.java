...
public abstract class SecurityUtil {
    ...
    public static String encodeBy36Radix(String str) {
        ...
        do {
            ...
            if (isSeven) {
                StringBuilder.append(StringUtil.enoughZero(Long.toString(longval, 36), 11));
            }
            else {
    ...
    public static void main(String[] args) {
		String str="3424234******FF$$%%";
		System.out.println("加密字符串:"+str);
		String result=encodeBy36Radix(str);
		System.out.println("加密后的结果:"+result);
		System.out.println("解密后的字符:"+decodeBy36Radix(result));
