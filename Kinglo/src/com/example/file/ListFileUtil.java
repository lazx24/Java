...
public class ListFileUtil {
     ...
     *            目录名
     */
    public static void listFilesByFilenameFilter(FilenameFilter filter,
	    String dirName) {
	...
	String dir = "D:\\51CTO下载-Java常用工具类";
	...
	// 新建一个文件名过滤器。参数为".txt"
	FilenameFilter myFilenameFilter = new ListFileUtil.MyFilenameFilter(
		".txt");
